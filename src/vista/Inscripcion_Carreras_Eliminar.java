...
public class Inscripcion_Carreras_Eliminar extends javax.swing.JFrame {
    ...
    public Inscripcion_Carreras_Eliminar() {
        initComponents();
 ...
 setResizable(false);
    ...
    private void initComponents() {
        ...
        jLabel5.setText("LISTADO DE INSCRIPCIONES A CARRERAS");
        ...
        jLabel2.setText("Introduzca el codigo de inscripcion a eliminar:");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Inscripcion_Carreras_Eliminar.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new Inscripcion_Carreras_Eliminar().setVisible(true);
            }
        });
    }
