...
public class Profesor_Eliminar extends javax.swing.JFrame {

    public JTable getJtConsultaProfesor() {
        return jtprofesores;
    }
    ...
    private void initComponents() {
        ...
        jLabel2.setText("Introduzca el DNI del profesor a eliminar:");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Profesor_Eliminar.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new Profesor_Eliminar().setVisible(true);
            }
        });
    }
