...
public class Inscripcion_Cursado_Eliminar extends javax.swing.JFrame {
    ...
    public Inscripcion_Cursado_Eliminar() {
        initComponents();
    ...
    private void initComponents() {
        ...
        jLabel5.setText("LISTADO DE INSCRIPCIONES A MATERIAS");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Inscripcion_Cursado_Eliminar.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new Inscripcion_Cursado_Eliminar().setVisible(true);
            }
        });
    }
