...
public class Materia_Eliminar extends javax.swing.JFrame {

    public JTable getJtConsultaMaterias() {
        return jtMaterias;
    }
    ...
    private void initComponents() {
        ...
        jtMaterias.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "CODIGO MATERIA", "NOMBRE DE MATERIA", "PROFESOR ASIGNADO"
            }
        ) {
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Materia_Eliminar.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new Materia_Eliminar().setVisible(true);
            }
        });
    }
